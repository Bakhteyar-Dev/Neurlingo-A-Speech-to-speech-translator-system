...
# ─── CSS — mirrors the original Gradio design exactly ─────────────────────────
st.markdown("""
<style>
...
.nl-panel-label {
    ...
    padding:9px 18px; margin:14px 14px 10px 14px;
...
/* ── Streamlit audio widget overrides ── */
...
<div class="nl-hero">
  <div class="nl-brand">
    ...
    <div>
      <div class="nl-main-title">Neurolingo</div>
      <div class="nl-subtitle">A Natural Language Translator from English to Balochi</div>
    </div>
  </div>
  <div class="nl-hero-right">
    <div class="nl-chip">Speech-to-Speech Translator</div>
    <div class="nl-toggle-box">
      <span class="nl-toggle-text">English</span>
      <label class="nl-switch">
        <input type="checkbox" id="ui-lang-toggle">
...
# Two-panel row: English input | Balochi output
col_in, col_out = st.columns(2, gap="medium")

with col_in:
    st.markdown("""
    <div class="nl-panel">
      <div class="nl-panel-label">♫ English Speech</div>
    </div>
    """, unsafe_allow_html=True)
...
with col_out:
    st.markdown("""
    <div class="nl-panel">
      <div class="nl-panel-label">♫ Balochi Speech</div>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown('</div>', unsafe_allow_html=True)  # close nl-card
...
if translate_clicked:
    if audio_input is None:
        ...
        try:
            ...
            # Show output audio in the right panel
